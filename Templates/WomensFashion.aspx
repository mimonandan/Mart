<%@ Page Title="" Language="C#" MasterPageFile="~/Templates/Layout.Master" AutoEventWireup="true" CodeBehind="WomensFashion.aspx.cs" Inherits="G_Kart.Templates.WomensFashion" %>
		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="../assets/images/banner4.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="../assets/images/banner3.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="../assets/images/banner1.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="../assets/images/bb1.jpg" alt=" " />
				</div>
